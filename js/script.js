const ApiKey = "b57858a6e27842fea09a7cee841b2ec3";
...
function showTeamInfo(id){
    ...
    fetch(TeamInfo, fetchHeader)
        ...
        .then(resJson => {
            ...
            let p = new Date(player.dateOfBirth).toLocaleDateString("id");
                squad += `
                <li class="collection-item">
                    <p> Nama        : <b>${player.name} </b><br>
                        Posisi      : ${player.position}<br>
                        Role        : ${player.role}<br>
                        Tanggal Lahir        : ${p}<br>
                        Negara Kelahiran    : ${player.countryOfBirth}<br>
